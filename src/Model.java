...
//    private Monster myMon;
     ...
     */
    void roomActivity(final int theRow, final int theCol) {
    ...
    //activate question sets for each monster type
    private void setQuestion() {
        banditQ =  myMaze.getMon().setQuestion("bandit", myPlayerClass, myQuestions);
        guardQ = myMaze.getMon().setQuestion("guard", myPlayerClass, myQuestions);
        gatekeeperQ = myMaze.getMon().setQuestion("gatekeeper", myPlayerClass, myQuestions);
    }
